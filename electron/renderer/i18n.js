...
const MESSAGES = {
  'zh-CN': {
    ...
    heroTitle: '一站式管理 VPN 节点抓取、测速与 Cloudflare 发布',
    heroBody: '统一配置抓包源、测速阈值和部署参数，并实时查看阶段状态、运行指标与日志摘要。',
    languageLabel: '界面语言',
    saveButton: '保存配置',
    runButton: '运行全流程',
    metricsTitle: '运行总览',
  ...
  'en-US': {
    ...
    eyebrow: 'LOCAL DASHBOARD',
    heroTitle: 'Manage VPN extraction, speed tests and Cloudflare publishing in one place',
    heroBody: 'Configure capture sources, thresholds and deploy settings, then watch stage status, metrics and runtime logs in real time.',
