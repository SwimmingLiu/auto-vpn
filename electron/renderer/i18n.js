...
const MESSAGES = {
  'zh-CN': {
    ...
    demoSourcesHint: '连接 Electron 后显示真实抓包地址',
    demoSpeedHint: '连接 Electron 后显示真实测速地址',
    demoDeployHint: '连接 Electron 后显示真实部署地址',
  ...
  'en-US': {
    ...
    brandSubtitle: 'Compact desktop console',
    eyebrow: 'LOCAL DASHBOARD',
    heroTitle: 'Track capture, speed tests, deployment and runtime health in one compact view',
    heroBody: 'Maintain sources, thresholds and publish settings in one console while keeping stage progress and log summaries visible.',
    ...
    speedCardSubtitle: 'Threshold / concurrency / multi-source average',
    deployCardTitle: 'Deploy',
    deployCardSubtitle: 'Pages / verify / subscription',
    metricsCardTitle: 'Run Metrics',
    metricsCardSubtitle: 'Summary / verify / throughput',
    ...
    demoSourcesHint: 'Connect through Electron to show live source endpoints',
    demoSpeedHint: 'Connect through Electron to show live speed-test endpoints',
    demoDeployHint: 'Connect through Electron to show live deployment endpoints',
    ...
    summarySpeedSources: '{count} speed sources, filter by average download speed',
    summaryDeploy: 'Project {project}',
    summaryRawLinks: 'Raw nodes {count}',
    summarySpeedPassed: 'Speed passed {count}',
    summaryAvailabilityPassed: 'Availability passed {count}',
    summaryVerifyState: 'Verify {status}',
    metricRawLinks: 'Raw nodes',
    metricDedupedLinks: 'Deduped',
    metricSpeedLinks: 'Speed passed',
    metricAvailabilityLinks: 'Availability passed',
