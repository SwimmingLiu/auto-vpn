...
def test_pipeline_controller_writes_transformed_worker_source(tmp_path: Path) -> None:
    ...
    (template_root / "vmess_node.js").write_text(
        Path("/Users/swimmingliu/data/VPN/vpn-subscription-automation/templates/vmess_node.js").read_text(
            encoding="utf-8"
        ),
        encoding="utf-8",
    )
    ...
    assert "// generated by vpn-subscription-automation" in transformed_source
