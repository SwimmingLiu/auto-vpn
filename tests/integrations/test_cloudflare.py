...
from vpn_automation.integrations.cloudflare import build_pages_deploy_command, build_secret_url
...
def test_build_secret_url_uses_pages_project_url_and_query() -> None:
    ...
    assert build_secret_url(deploy) == "https://vmess2clash.pages.dev/?serect_key=swimmingliu"
